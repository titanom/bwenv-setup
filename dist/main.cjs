  ...
  "node_modules/.pnpm/@actions+tool-cache@2.0.1/node_modules/@actions/tool-cache/lib/tool-cache.js"(exports) {
    ...
    function downloadToolAttempt(url, dest, auth2, headers) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const http2 = new httpm.HttpClient(userAgent2, [], {
          allowRetries: false
        });
        if (auth2) {
...
async function getLatestVersion() {
  try {
    ...
    core.error("Failed to fetch the latest release:", error2);
    throw error2;
  }
}
...
async function downloadFile(fileURL, destination) {
  ...
  return new Promise(
    (resolve, reject) => response.message.pipe(fileStream).on("close", () => resolve(destination)).on("error", (error2) => reject(error2))
  );
}
...
async function run() {
  try {
    const version2 = core.getInput("version", { required: false });
    const releaseURL = getReleaseURL(version2);
